...
def build():
    ...
    add_para(doc,
        ...
        "본 벤치마크의 양성 50케이스는 대부분(46/50) 2026년 5~6월 NVD 신규 공개 CVE 패턴에서 도출했다(NVD API 수집: "
        "2026-04-30~06-09, 총 9,134건 중 CWE 보유 8,216건). 나머지 4건은 동일 CWE 계열의 2026년 신규 사례가 부족해 "
        "근접 시점 CVE(2023~2025)로 보강했다.", size=11)
    doc.add_page_break()
