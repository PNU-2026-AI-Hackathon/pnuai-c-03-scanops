...
OUT = BASE / "data" / "lora_train_v7.jsonl"
V4_PATH = BASE / "data" / "lora_train_v4.jsonl"
SEED = 17
N_OWASP_VULN = 250   # OWASP 취약(긴 Java) — 스타일 단축경로 차단의 핵심
N_OWASP_SAFE = 250   # OWASP 안전(긴 Java) — 균형
N_SYNTH_VULN = 120   # 합성 취약(짧은 스니펫, 언어 다양성 보조)
