...
/**
 * Feather icons (https://feathericons.com, MIT). Single source of truth for
 * all iconography — stroke-based, 24×24, currentColor. Add new glyphs by
 * pasting the icon's inner SVG from feathericons.com into PATHS below.
 */
export type IconName =
  | 'globe' | 'github' | 'git-pull-request' | 'git-branch' | 'code' | 'terminal'
  | 'check' | 'check-circle' | 'check-square' | 'x' | 'x-circle'
  | 'alert-triangle' | 'alert-circle' | 'info' | 'shield'
  ...
  | 'key' | 'link' | 'star' | 'target' | 'trending-down' | 'trending-up'
  | 'edit-3' | 'box' | 'message-circle' | 'send'
